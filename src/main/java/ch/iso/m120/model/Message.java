...
public class Message implements DatabaseObject {
	...
	public Message(Integer id, Integer chatid, String value, Date time) {
		super();
		this.setId(id);
	...
	/*
	 * public final SimpleIntegerProperty templateidProperty() { return
	 * this.templateid; }
	 * 
	 * public final int getTemplateid() { return this.templateidProperty().get(); }
	 * 
	 * public final void setTemplateid(final int templateid) {
	 * this.templateidProperty().set(templateid); }
	 * 
	 * public final SimpleIntegerProperty formidProperty() { return this.formid; }
	 * 
	 * public final int getFormid() { return this.formidProperty().get(); }
	 * 
